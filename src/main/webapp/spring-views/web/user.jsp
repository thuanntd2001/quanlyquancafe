															...
															<<<<<<< HEAD <img src="files/${user.icon}"
																...
																<div class="pt-2">
																	...
																	<button class="btn btn-danger btn-sm"
																		title="Gỡ avata" data-toggle="modal"
																		data-target="#removeAvata">
																		<i class="fas fa-trash-alt"></i>
																	</button>
																	<div class="modal fade" id="removeAvata"
																		...
																		<div class="modal-dialog" role="document">
																			<div class="modal-content">
																				...
																				<div class="modal-body">Bạn thật sự muốn
																					gỡ ảnh đại diện?</div>
