                        ...
                        <div class="col-xl-4">
                            ...
                            <div class="card">
                                <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                                    <img src="<c:url value='./common/images/avt.jpg' />" alt="Profile" class="rounded-circle">
                                    ...
                                    <ul class="nav nav-tabs nav-tabs-bordered">
                                        ...
                                        <li class="nav-item">
                                            <button class="nav-link" data-bs-toggle="tab"
                                                data-bs-target="#profile-edit">Sửa
                                                Thông Tin </button>
                                        </li>
                                    ...
                                    <div class="tab-content pt-2">
                                        ...
                                        <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-9 col-md-8">52 Man Thiện, Tăng Nhơn Phú A, Q9, TPHCM
                                                </div>
                                            </div>
                                            ...
                                            <form>
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-8 col-lg-9">
                                                        <img src="<c:url value='./common/images/avt.jpg' />" alt="ảnh đại diện" class="avt-pic">
                                                        <div class="pt-2">
                                                            <div class="btn btn-primary btn-sm"
                                                                style="position: relative;">
                                                                <input type="file" accept=".jpg, .png"
                                                                    class="file-upload" name="avt"/>
                                                ...
                                                <div class="row mb-3">
                                                    <label for="myid" class="col-md-4 col-lg-3 col-form-label">Mã Nhân
                                                        Viên</label>
                                                    <div class="col-md-8 col-lg-9">
                                                ...
                                                <div class="row mb-3">
                                                    <label for="sex" class="col-md-4 col-lg-3 col-form-label">Giới
                                                        Tính</label>
                                                    <div class="col-md-8 col-lg-9">
                                                        <input id="male" type="radio" name="sex" value="Nam" checked />
                                                        <label for="male">Nam</label>
                                                        <input id="female" type="radio" name="sex" value="Nữ" />
                                                ...
                                                <div class="row mb-3">
                                                    <label for="phone"
                                                        class="col-md-4 col-lg-3 col-form-label">SDT</label>
                                                    <div class="col-md-8 col-lg-9">
                                                ...
                                                <div class="row mb-3">
                                                    <label for="username" class="col-md-4 col-lg-3 col-form-label">Tên
                                                        Tài
                                                        Khoản</label>
                                                    <div class="col-md-8 col-lg-9">
                                            ...
                                            <form>
                                                ...
                                                <div class="row mb-3">
                                                    <label for="newPassword"
                                                        class="col-md-4 col-lg-3 col-form-label">Mật
                                                        Khẩu Mới</label>
                                                    <div class="col-md-8 col-lg-9">
